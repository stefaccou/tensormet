...
from routing import get_update_routing
...
def non_negative_tucker_with_similarity(
    ...
    try:
        ...
        routing = get_update_routing(divergence=divergence, dim=dim)
    except:
    ...
    for iteration in range(n_iter_max):
        ...
        if iteration >= warmup_steps and has_prev_err and do_rec_check:
