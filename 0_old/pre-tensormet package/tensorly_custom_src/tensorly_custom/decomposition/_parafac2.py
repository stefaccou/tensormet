...
from tensorly_custom.random import random_parafac2
from tensorly_custom import backend as T
...
class _BroThesisLineSearch:
    def __init__(
        ...
        svd : str
            The function to use to compute the SVD, acceptable values in tensorly_custom.SVD_FUNS
        verbose : bool
