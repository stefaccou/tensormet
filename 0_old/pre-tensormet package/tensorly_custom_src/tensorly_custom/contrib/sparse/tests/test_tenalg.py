"""Sparse-specific tests for the :mod:`tensorly_custom.tenalg` module.
"""
...
import tensorly_custom.contrib.sparse as stl
from tensorly_custom.contrib.sparse.cp_tensor import (
