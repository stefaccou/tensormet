...
class CustomPyTorchSparseBackend(Backend, backend_name="custom_pytorch_sparse"):
    @staticmethod
    def context(tensor):
        return {
            "dtype": tensor.dtype,
...
for name in (
    ...
    CustomPyTorchSparseBackend.register_method(name, getattr(torch, name))
...
for name in ["solve", "qr", "svd", "eigh"]:
    CustomPyTorchSparseBackend.register_method(name, getattr(torch.linalg, name))
