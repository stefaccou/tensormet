...
class Backend:
    ...
    def index_update(tensor, indices, values):
        """Updates the value of tensors in the specified indices
            Should be used as::
                ...
                index_update(tensor, tensorly_custom.index[:, 3:5], values)
        ...
        indices : tensorly_custom.index
            indices to update
        values : tensorly_custom.tensor
    ...
    def partial_svd(self, *args, **kwargs):
        msg = (
            ...
            "Please use tensorly_custom.tenalg.svd_interface instead, "
    ...
    def kr(self, matrices, weights=None, mask=None):
        msg = (
            ...
            "Please use tensorly_custom.tenalg.khatri_rao instead, "
