...
#          Aaron Meyer <tensorly_custom@ameyer.me>
...
def svd_interface(
    ...
    **kwargs,
    ...
    method : str, default is 'truncated_svd'
        Function to use to compute the SVD, acceptable values in tensorly_custom.SVD_FUNS or a callable.
    n_eigenvecs : int, optional, default is None
        If specified, number of eigen[vectors-values] to return.
